...
def battle(player, enemy):
    ...
    while victory:
        ...
        if enemy.getCurrentHP() <= 0:
            print(
                "You defeated the enemy!! Congratulations! Prepare for the next enemy!\n"
            )
...
def main():
    ...
    playerName = input(
        "Welcome to the Famous Battle Gauntlet of DOOM. What is your name, challenger? "
    )
    print(
        "You have 60 points available to distribute among your six stats, those being hp, strength, magic, defense, resistance, and speed"
    )

    print(
        "You may distribute them in any way you wish. You will not be allowed to extend the limit of 60."
    )
    ...
    if availableStatDistribution < 0:
        print(
            "You cannot enter that many points into that stat. You have been disqualified. Run the program again."
        )
        return
    ...
    while defeated is False:
        ...
        if victory is True:
            ...
            print(
                "You lost!! You have ",
                player.victories,
                "victories! Try again by running the program again!",
            )
