...
while True:
    my_password = int(
        input("To continue your Python experience, please input the password: ")
    )
...
while True:
    choice = input(
        "What would you like to do? Your choices are Open Browser | Talk to a therapist | Power Off » "
    )
