...
def trap():
    print(
        "You have encountered some zombie's affected by the radiaation\n"
    ...
    while True:
        ...
        if next == "A" or next == "a":
            ...
            death(
                "You only had two options but since you did'nt choose any you are dead"
            )


def b_room():
    print(
        "You choose the second option thus you have made it safely to the b room now\n"
...
def d_room():
    print()
    print(
        "you have spawned into the d room\n"
...
def lake():
    print(
        "You have moved forward to the lake\n"
