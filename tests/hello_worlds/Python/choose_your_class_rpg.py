class Player:
    def __init__(
        ...
        self.directions = {
            "start": {
                "forest": "You are in a forest, look around... the silence, the trees, you are trying"
            ...
            "north": [
                {
                    "Palace of Nather": {
                        ...
                        "Items": {"rope": 1, "gold": 0.2, "arrows": 1},
                        "Options": [],
                        "Enemies": {},
                    }
                },
    ...
    def player_class_selection(self, char_class_picked: str):
...
class Inventory:
    ...
    def add_to_attribute(self, attr, quantity: int = 0):
...
class Journey:
    ...
    def get_player(self, username, char_class):
        self.player = Player(username=username, player_class=char_class)
        return self.player
...
if __name__ == "__main__":
    ...
    player = setting_player.get_player(username=input_username, char_class=None)
    ...
    for status, value in player.CHAR_CLASSES[
        list_of_char_classes[input_class - 1]
    ].items():
