...
ap.add_argument(
    ...
    "--tracker",
    required=False,
    help='''Name of the Tracker. List of Available Trackers in OpenCV: "csrt", "kcf", "boosting", "mil", "tld", "medianflow", "mosse"''',
)
...
while True:
    ...
    if init_BB is not None:
        ...
        info = [("Tracker Used: ", tracker_name), ("FPS: ", "{:.2f}".format(fps.fps()))]
