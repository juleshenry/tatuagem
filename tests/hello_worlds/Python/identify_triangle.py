...
print(
    "This program calculates a triangle's type based on either three sides or three angles inputted by the user."
)
...
while keepCalculating:
    ...
    mode = str(
        input(
            "Will you be entering three angles (enter 'A') or three sides (enter 'S')? "
        )
    )
    triangleType = ""
    ...
    if mode == "A":
        while True:
            try:
                ...
                print(
                    "Invalid input, please input a valid first angle "
        ...
        while True:
            try:
                ...
                print(
                    "Invalid input, please input a valid second angle "
                    "(greater than 0.0 and less than or equal to "
                    + str(180.0 - angleOne)
                    + ")."
                )
            else:
        ...
        while True:
            try:
                ...
                print(
                    "Invalid input, please input a third angle "
                    "(greater than 0.0 and less than or equal to "
                    + str(180.0 - angleOne - angleTwo)
                    + ")."
                )
            else:
        ...
        if angleOne + angleTwo + angleThree != 180:
            print(
                "This is not a valid triangle, please try again. The angles must add up to 180 degrees. "
            )
            continue

    elif mode == "S":
        print(
            "Remember to use the same units for each side length. "
            "(e.g. All side lengths are entered in centimeters, all side lengths are entered in metres, etc.)"
        )
        while True:
            try:
                sideOne = float(
                    input("Input your first side length (a number greater than 0.0): ")
                )
            except ValueError:
        ...
        while True:
            try:
                sideTwo = float(
                    input("Input your second side (a number greater than 0.0): ")
                )
            except ValueError:
                print("Invalid input, please input a number greater than 0.0. ")
            else:
        ...
        while True:
            try:
                sideThree = float(
                    input("Input your third side (a number greater than 0.0): ")
                )
            except ValueError:
                print("Invalid input, please input a number greater than 0.0. ")
            else:
        ...
        if (
            ...
            and sideTwo + sideThree > sideOne
            and sideOne + sideThree > sideTwo
        ):
            angleOne = math.degrees(
                math.acos(
                    ((sideOne**2) + (sideTwo**2) - (sideThree**2))
                    / (2 * sideOne * sideTwo)
                )
            )
            angleTwo = math.degrees(
                math.acos(
                    ((sideTwo**2) + (sideThree**2) - (sideOne**2))
                    / (2 * sideTwo * sideThree)
                )
            )
            angleThree = math.degrees(
                math.acos(
                    ((sideThree**2) + (sideOne**2) - (sideTwo**2))
                    / (2 * sideThree * sideOne)
                )
            )
            print(
                "The three angles of this triangle (rounded to the nearest hundredth) are "
                + str(round(angleOne, 2))
                + " degrees, "
                + str(round(angleTwo, 2))
                + " degrees, and "
                + str(round(angleThree, 2))
                + " degrees."
            )
        else:
            print(
                "Invalid triangle, please try again. The sum of any two sides of the triangle must be more than "
    ...
    if (angleOne == angleTwo) ^ (angleTwo == angleThree) and (
        angleTwo == angleThree
    ) ^ (angleThree == angleOne):
    ...
    if angleOne < 60 and angleTwo < 60 and angleThree < 60:
        ...
        print(
            "This triangle is an obtuse " + triangleType + " triangle. "
    ...
    while True:
        userInput = str(
            input(
                "Enter 'continue' to solve another triangle (restart the program), "
                "enter 'quit' to exit. "
            )
        )
        if userInput == "quit":
