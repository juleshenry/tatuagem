...
if len(sys.argv) < 2:
    print(
        "Ademas de llamar al programa indique el numero natural cuyos primos menores desea obtener"
    )
elif len(sys.argv) > 2:
    print(
        "Demasiados argumentos: Solo indique %s + el numero del que quiera obtener sus primos menores",
        sys.argv[0],
    )
